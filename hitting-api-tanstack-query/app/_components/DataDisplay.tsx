    ...
    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-red-600 font-medium">Error: {error instanceof Error ? error.message : "An error occurred"}</div>
            </div>
        );
    }

    // Combine fetched albums with locally added albums
